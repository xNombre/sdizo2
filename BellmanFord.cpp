...
Array<PathNode> BellmanFord::getShortestPath(const ListGraph &graph, const size_t &from)
{
...
Array<PathNode> BellmanFord::getShortestPath(const MatrixGraph &graph, const size_t &from)
{
...
template<typename T>
TotalPathCost BellmanFord::getShortestPathFromTo(const T &graph,
...
template TotalPathCost BellmanFord::getShortestPathFromTo(const MatrixGraph &graph,
                                                          const size_t &from,
                                                          const size_t &to);
template TotalPathCost BellmanFord::getShortestPathFromTo(const ListGraph &graph,
                                                          const size_t &from,
                                                          const size_t &to);