...
Array<PathNode> Dijkstra::getShortestPath(const ListGraph &graph, const size_t &from)
{
...
Array<PathNode> Dijkstra::getShortestPath(const MatrixGraph &graph, const size_t &from)
{
...
template<typename T>
TotalPathCost Dijkstra::getShortestPathFromTo(const T &graph, const size_t &from, const size_t &to)
{
...
template TotalPathCost Dijkstra::getShortestPathFromTo(const MatrixGraph &graph,
                                                       const size_t &from,
                                                       const size_t &to);
template TotalPathCost Dijkstra::getShortestPathFromTo(const ListGraph &graph,
                                                       const size_t &from,
                                                       const size_t &to);